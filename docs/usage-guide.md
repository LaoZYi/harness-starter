...
3. **初始化** — 生成文档、规则、任务追踪和 28 个工作流技能命令
...
初始化后，项目中会生成 28 个 Claude Code 斜杠命令，覆盖完整开发生命周期。
...
框架的 28 个技能模板改编自 3 个上游项目 + 1 个吸收项目。当上游更新时，可以检查变更：
